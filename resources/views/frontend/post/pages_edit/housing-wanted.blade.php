                ...
                <div class="col-lg-6">
                    <div class="form-check">
                        <input class="form-check-input" type="checkbox" name="broker_fee"
                            {{ $ad->broker_fee ? 'checked' : '' }} id="broker_1" value="1">
                    ...
                    <div class="mb-1">
                        ...
                        <input type="text" name="fee_detailed" id="broker_fee_detailed"
                            {{ $ad->fee_detailed ? 'checked' : '' }} class="form-control" disabled>
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="form-check">
                        <input class="form-check-input" type="checkbox" name="application_fee"
                            {{ $ad->application_fee ? 'checked' : '' }} id="application_1" value="1">
                    ...
                    <div class="mb-1">
                        <label for="fee_detailed" class="form-label">detailed fee description
                            please</label>
                        <input type="text" name="fee_detailed" {{ $ad->fee_detailed }} id="application_fee_detailed"
