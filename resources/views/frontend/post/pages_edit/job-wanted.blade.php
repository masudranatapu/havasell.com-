<div class="row">
                    ...
                    <div class="mb-3">
                        ...
                        <select name="education" id="education" class="form-control">
                            ...
                            <option value="less than high school"
                                {{ $ad->education == 'less than high school' ? 'selected' : '' }}>less than high school
                            </option>
                ...
                <div class="col-md-6">
                    <div class="form-check">
                        <input class="form-check-input" type="checkbox"
                            name="direct_contact"{{ $ad->direct_contact ? 'checked' : '' }} id="direct_contact"
    ...
    <div class="col-12 mb-3">
        <div class="form-check me-3" style="display:inline-block;">
            <input class="form-check-input" type="radio" name="is_license"
                id="unlicensed"{{ $ad->is_license == 0 ? 'checked' : '' }} value="0" checked>
        ...
        <div class="form-check me-3" style="display:inline-block;">
            <input class="form-check-input" type="radio" name="is_license"
                id="licensed"{{ $ad->is_license == 1 ? 'checked' : '' }} value="1">
        ...
        <div class="mb-3">
            ...
            <input type="text" name="license_info" id="license_info" value="{{ $ad->license_info }}"
    ...
    <div class="col-12">
        <div class="form-check">
            <input class="form-check-input" type="checkbox" id="term_condition" name="other_contact"
                {{ $ad->other_contact == 1 ? 'checked' : '' }} {{ $ad->other_contact ? 'checked' : '' }}
                value="1">
