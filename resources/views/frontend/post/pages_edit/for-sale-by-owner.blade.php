                    ...
                    <div class="col-lg-10">
                        <div class="mb-1">
                            ...
                            <select name="condition" id="condition" class="form-control">
                                ...
                                <option value="new" {{ $ad->phone == 'new' ? 'selected' : '' }}>new</option>
                                <option value="like new" {{ $ad->phone == 'like new' ? 'selected' : '' }}>like new
                                </option>
                                <option value="excellent" {{ $ad->phone == 'excellent' ? 'selected' : '' }}>excellent
                                </option>
                                <option value="good" {{ $ad->phone == 'good' ? 'selected' : '' }}>good</option>
                                <option value="fair" {{ $ad->phone == 'fair' ? 'selected' : '' }}>fair</option>
                                <option value="salvage" {{ $ad->phone == 'salvage' ? 'selected' : '' }}>salvage</option>
                            </select>
                        </div>
                    </div>
                    <div class="mb-1">
                        <label for="phone" class="form-label"><small class="text-success">language of
                                posting <span class="text-danger">*</span></small></label>
