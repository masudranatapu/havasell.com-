            ...
            <div class="row">
                ...
                <div class="col-md-6 col-lg-3">
                    <div class="select_dropdown">
                        ...
                        <select name="houssing_type" id="houssing_type" class="form-control">
                            <option value="apartment" {{ $ad->houssing_type == 'apartment' ? 'selected' : '' }}>
                                apartment</option>
                            ...
                            <option value="cotage/cabin" {{ $ad->houssing_type == 'cotage/cabin' ? 'selected' : '' }}>
                                cotage/cabin</option>
                            <option value="duplex" {{ $ad->houssing_type == 'duplex' ? 'selected' : '' }}>duplex
                            </option>
                            ...
                            <option value="in-law" {{ $ad->houssing_type == 'in-law' ? 'selected' : '' }}>in-law
                            </option>
                            <option value="loft" {{ $ad->houssing_type == 'loft' ? 'selected' : '' }}>loft</option>
                            <option value="townhouse" {{ $ad->houssing_type == 'townhouse' ? 'selected' : '' }}>
                                townhouse</option>
                            <option value="manufactured" {{ $ad->houssing_type == 'manufactured' ? 'selected' : '' }}>
                                manufactured</option>
                            <option value="assisted living"
                                {{ $ad->houssing_type == 'assisted living' ? 'selected' : '' }}>assisted living
                            </option>
                        </select>
                    </div>
                    <div class="select_dropdown">
                        ...
                        <select name="laundry" id="laundry" class="form-control">
                            ...
                            <option value="w/d in unit" {{ $ad->laundry == 'w/d in unit' ? 'selected' : '' }}>w/d in
                                unit</option>
                            <option value="w/d hookups" {{ $ad->laundry == 'w/d hookups' ? 'selected' : '' }}>w/d
                                hookups</option>
                            ...
                            <option value="no lanudry on site"
                                {{ $ad->laundry == 'no lanudry on site' ? 'selected' : '' }}>no lanudry on site</option>
                        </select>
                    </div>
                    <div class="select_dropdown">
                        ...
                        <select name="parking" id="parking" class="form-control">
                            ...
                            <option value="off-street parking"
                                {{ $ad->parking == 'off-street parking' ? 'selected' : '' }}>off-street parking</option>
                ...
                <div class="col-md-6 col-lg-3">
                    <div class="mb-3">
                        ...
                        <input type="date" name="available_on" {{ $ad->available_on }} id="available_on"
                            class="form-control">
                    </div>
                </div>
            </div>
                    ...
                    <div class="mb-3">
                        ...
                        <div class="form-check">
                            <input class="form-check-input" type="radio"
                                name="email_privacy"{{ $ad->email_privacy == 1? 'checked' : '' }} id="privacy_3"
    ...
    <div class="col-12">
        <div class="form-check">
            <input class="form-check-input" type="checkbox" id="term_condition" name="other_contact"
                {{ $ad->other_contact == 1 ? 'checked' : '' }} value="1">
