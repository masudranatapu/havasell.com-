        ...
        <div class="form_wrapper">
            ...
            <div class="row">
                ...
                <div class="col-md-8 inline_checkbox disabled_checked">
                    ...
                    <div class="form-check">
                        <input class="form-check-input" type="checkbox" name="phone_call" {{ $ad->phone_call ? 'checked'
                    ...
                    <div class="form-check">
                        <input class="form-check-input" type="checkbox" name="phone_text" {{ $ad->phone_text ? 'checked'
    ...
    <div class="col-12">
        <div class="form-check">
            <input class="form-check-input" type="checkbox" id="term_condition" name="other_contact" {{
                $ad->other_contact? "checked" : "" }} value="1" required>
