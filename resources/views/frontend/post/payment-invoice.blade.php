                    ...
                    <div class="card p-4 w-100 mb-5">
                        ...
                        <table class="table table-striped table-bordered dt-responsive nowrap">
                            <tbody>
                                ...
                                <tr class="mb-5">
                                    <th width="20%">{{ __('Promotion Name') }}</th>
                                    <td width="80%">{{ $promotion->title ?? '' }}</td>
                                </tr>
                                @if($ad->feature_duration)
                                    <tr class="mb-5">
                                        <th width="20%">{{ __('Ad Promotion Duration') }}</th>
                                        <td width="80%">{{\Carbon\Carbon::parse($ad->feature_duration)->format('d M Y')}}</td>
                                    </tr>
                                @endif
                                <tr class="mb-5">
