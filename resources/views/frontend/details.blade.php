                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <ul class="mb-4">
                                        ...
                                        <li>Start Date: <strong>{{ date('d M, Y',
                                                strtotime($ad_details->event_start_date))
                                                }}</strong></li>
                                        <li>End Date: <strong>{{ date('d M, Y', strtotime($ad_details->event_end_date))
                                                }}</strong></li>
                                ...
                                <div class="col-md-6">
                                    <ul class="mb-4">
                                        ...
                                        <li>Phone Call: <strong>{{ $ad_details->phone_call == 1 ? 'Yes' : 'No'
                                                }}</strong>
                                        </li>
                                        <li>Phone Text: <strong>{{ $ad_details->phone_text == 1 ? 'Yes' : 'No'
                                                }}</strong>
                                        </li>
