        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ route('promotion.update',$data->id) }}" method="post"
                            id="promotion_form">
                            @csrf
                                ...
                                <div class="col-md-6 col-lg-6">
                                    <div class="form-group {!! $errors->has('order_id') ? 'error' : '' !!}">
                                        <label for="order_id">{{ __('order id')}} <span
                                                class="text-danger">*</span></label>
                                        <div class="controls">
                                            <input type="number" name="order_id" id="order_id" value="{{ $data->order_id }}"
                                                class="form-control mb-1" placeholder="order_id"
                                                tabindex="{{ $tabindex++ }}" required>
